...
import './Special.css';
import Akc from '../../img/akc.jpg';
import Akc2 from '../../img/akc2.jpg';
import Akc3 from '../../img/akc3.jpg';
    ...
    <div>
      <section className="special-offer">
        <div className="container">
          <div className="page-title">Специальные предложения</div>
          <div className="special-offer__block">
            <div className="special-offer__block-item">
              <img src={Akc} alt="" />
              <div className="special-offer__block-item-txt">
                <div className="text1">Выгодная комбинация</div>
                <div className="text2">
                  <p>
                    {' '}
                  ...
                  <p>
                    Чтобы узнать условия акции оставляйте заявку или звоните по
                    номеру 0(800)-50-86-22
                  </p>
                </div>
                <button className="video-btn">Оставить заявку</button>
              </div>
            </div>
          </div>
          <div className="special-offer__block">
